...
export const chapters = [
  ...
  },
  {
    ...
    text: "Hay una versión de mí que sólo aparece cuando estoy contigo. Habla más, se ríe más, dice lo que piensa sin darle tantas vueltas y simplemente se siente tranquila.\nNo sé exactamente qué haces para sacarla de mí, pero me encanta.\nCreo que me gusta más esa versión de mí, porque contigo no siento que tenga que fingir ni pensar demasiado. Y lo más bonito es que, cuando colgamos, esa versión se queda conmigo un ratito más.",
    palette: "rubor",
    mood: "glass",
  },
  {
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    text: "No es nada material y ya lo sabías… bueno, en realidad sí es un regalito esta vez 🥹.\nEs mi regalo de cumpleaños adelantado. Sí, ya sé que mañana cumples añitos, pero no quería esperar para darte tu regalito.\nQuiero comprarte ropita de SHEIN y quiero que tú elijas lo que quieras. De verdad, no te preocupes por qué escoger ni por el precio; pueden ser blusitas, pantalones, pijamas, ropa interior o cualquier cosita que te guste. Quiero que elijas lo que de verdad quieras y necesites.\nSé que necesitas ropita y me hace mucha ilusión poder regalártela. Quiero que abras SHEIN, veas todo lo que te guste y me mandes tus cositas para comprártelas yo. 🥹💗\nAsí que sí, este es mi regalito adelantado para ti, mi amorcito. No es sólo ropa; es una pequeña manera de decirte que me encanta consentirte y poder darte algo que sea completamente tuyo.",
    reveal: "Feliz casi cumpleaños, mi niña linda. Te amo muchísimo.",
    palette: "azucar",
    mood: "bloom",
  },
  {
